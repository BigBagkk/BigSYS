...
class Riskcheck extends CommAction {
	/*
	 * 票务风险与对策检查
	 */
	public function ticketRiskCheckRecord() {
		return $this->fetch ();
	}
	/*
	 * 乘务系列风险与对策检查通报表
	 */
	public function driverRiskCheckRecord() {
		return $this->fetch ();
	}
	/*
	 * 维修系列风险与对策检查
	 */
	public function maintainRiskCheckRecord() {
		return $this->fetch ();
	}
	/*
	 * 站务系列风险与对策检查
	 */
	public function stationRiskCheckRecord() {
		return $this->fetch ();
	}
